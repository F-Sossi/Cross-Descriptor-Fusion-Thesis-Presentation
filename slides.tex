...
\begin{frame}{Thesis in One Sentence}
  ...
  \begin{beamercolorbox}[sep=1em, rounded=true, shadow=true, center]{block body}
    \large
    Systematic fusion of keypoint detectors and descriptors significantly improves local feature matching.
  \end{beamercolorbox}
  \vfill
...
\begin{frame}{Keypoint Quality Matters More Than Descriptor Choice}
  \begin{itemize}
